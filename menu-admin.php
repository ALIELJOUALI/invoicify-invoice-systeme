...
<ul class="nav navbar-nav flex-row">
    <li class="dropdown">
        ...
        <li>
            <a class="dropdown-item" href="manage-user.php">User list</a></li>
            <li><a class="dropdown-item" href="admin.php">Invoice List</a></li>
            <li><a class="dropdown-item" href="create_invoice_admin.php">Create Invoice</a></li>                  
