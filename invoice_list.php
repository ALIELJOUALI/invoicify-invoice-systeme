        ...
        foreach($invoiceList as $invoiceDetails){
            ...
            echo '
              <tr>
                ...
                <td><a href="phpmailer\index.php?invoice_id='.$invoiceDetails["order_id"].'" title="Send Email"><button class="btn btn-info btn-sm"><i class="fa fa-envelope"></i></button></a></td>
                </tr>
            ';
        }       
        ?>
